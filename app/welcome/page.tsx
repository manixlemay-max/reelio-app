  ...
  return (
    <div className="max-w-lg mx-auto py-16 px-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          <label className="block text-sm mb-1 text-neutral-300">Your name</label>
          <input
            required
            value={form.name}
        ...
        <div>
          <label className="block text-sm mb-1 text-neutral-300">Business / brand name</label>
          <input
            required
        ...
        <div>
          <label className="block text-sm mb-1 text-neutral-300">Anything else we should know?</label>
          <textarea
            rows={3}
            value={form.notes}
