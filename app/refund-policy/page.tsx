...
export default function RefundPolicyPage() {
  return (
    <main className="flex-1 mx-auto max-w-2xl px-6 py-16 text-sm text-neutral-600 leading-relaxed">
      <h1 className="text-2xl font-semibold text-neutral-900 mb-2">Refund Policy</h1>
      ...
      <h2 className="text-lg font-medium text-neutral-900 mt-8 mb-2">Cancellations</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg font-medium text-neutral-900 mt-8 mb-2">Exceptions</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg font-medium text-neutral-900 mt-8 mb-2">Contact</h2>
      <p className="mb-4">
