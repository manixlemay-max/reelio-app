...
export default function PrivacyPage() {
  return (
    <main className="flex-1 mx-auto max-w-2xl px-6 py-16 text-sm text-neutral-600 leading-relaxed">
      ...
      <h2 className="text-lg font-medium text-neutral-900 mt-8 mb-2">1. Information we collect</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg font-medium text-neutral-900 mt-8 mb-2">2. How we use your information</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg font-medium text-neutral-900 mt-8 mb-2">3. Third-party services</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg font-medium text-neutral-900 mt-8 mb-2">4. Data retention</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg font-medium text-neutral-900 mt-8 mb-2">5. Your rights</h2>
      <p className="mb-4">
        You can request access to, correction of, or deletion of your personal information at
        any time by contacting us.
      </p>

      <h2 className="text-lg font-medium text-neutral-900 mt-8 mb-2">6. Contact</h2>
      <p className="mb-4">
